      ...
      child: Scaffold(
        ...
        body: Consumer<PaymentViewModel>(
          builder: (context, model, child) => SingleChildScrollView(
            child: (_viewModel.statusPayment == EnumStatusPayment.cancel)
                ? CancelPaymentWidget(
                    config: widget.config,
                  )
                : (_viewModel.statusPayment == EnumStatusPayment.successful)
                    ...
                    : (_viewModel.statusPayment == EnumStatusPayment.failed)
                        ? widget.errorBuilder
                                ?.call(_viewModel.responsePayment!) ??
                            FailedPaymentWidget(
                              responsePayment: _viewModel.responsePayment!,
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Text(
                                                    widget.payment.designation,
                                                    style: GoogleFonts.poppins(
                                                      fontSize: 14,
                                                      color:
                                                          AppColors.colorTexte,
                                                      fontWeight:
                                                          FontWeight.w400,
                                                    ),
                                                  ),
                                                  ...
                                                  verticalSpaceSmall,
                                                  Text(
                                                    "${formatNumber(widget.payment.amount.toInt())} ${widget.payment.currency}",
                                                    style: GoogleFonts.poppins(
                                                      fontSize: 22,
                                                      color: AppColors.black,
                                                      fontWeight:
